...
var ASM_CONSTS = {
  ...
  163518: () => (navigator.mediaDevices === undefined) ? 0 : 1,
  163577: ($0, $1, $2, $3, $4, $5, $6) => {
    const device = $0;
    const w = $1;
    const h = $2;
  ...
  168096: () => Module["SDL3"].audioContext.sampleRate,
  168147: ($0, $1, $2, $3) => {
    var SDL3 = Module["SDL3"];
  ...
  181871: () => window.innerWidth,
  181901: () => window.innerHeight,
  181932: $0 => {
