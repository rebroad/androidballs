...
var ASM_CONSTS = {
  ...
  161710: () => (navigator.mediaDevices === undefined) ? 0 : 1,
  161769: ($0, $1, $2, $3, $4, $5, $6) => {
    const device = $0;
    const w = $1;
    const h = $2;
  ...
  166288: () => Module["SDL3"].audioContext.sampleRate,
  166339: ($0, $1, $2, $3) => {
    var SDL3 = Module["SDL3"];
  ...
  180063: () => window.innerWidth,
  180093: () => window.innerHeight,
  180124: $0 => {
