...
var ASM_CONSTS = {
  ...
  161950: () => (navigator.mediaDevices === undefined) ? 0 : 1,
  162009: ($0, $1, $2, $3, $4, $5, $6) => {
    const device = $0;
    const w = $1;
    const h = $2;
  ...
  166528: () => Module["SDL3"].audioContext.sampleRate,
  166579: ($0, $1, $2, $3) => {
    var SDL3 = Module["SDL3"];
  ...
  180303: () => window.innerWidth,
  180333: () => window.innerHeight,
  180364: $0 => {
