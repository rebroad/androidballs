...
function findWasmBinary() {
  return locateFile("3x2-web-debug.wasm");
}
...
var readEmAsmArgs = (sigPtr, buf) => {
  ...
  while (ch = SAFE_HEAP_LOAD(HEAPU8, sigPtr++)) {
    ...
    ch == 112 ? SAFE_HEAP_LOAD(HEAPU32, ((buf) >> 2)) : ch == 106 ? SAFE_HEAP_LOAD(HEAP64, ((buf) >> 3)) : ch == 105 ? SAFE_HEAP_LOAD(HEAP32, ((buf) >> 2)) : SAFE_HEAP_LOAD(HEAPF64, ((buf) >> 3)));
    buf += wide ? 8 : 4;
  }
...
var fillGamepadEventData = (eventStruct, e) => {
  ...
  for (var i = 0; i < e.buttons.length; ++i) {
    if (typeof e.buttons[i] == "object") {
      SAFE_HEAP_STORE(HEAPF64, (((eventStruct + i * 8) + (528)) >> 3), e.buttons[i].value);
    } else {
...
var readI53FromU64 = ptr => SAFE_HEAP_LOAD(HEAPU32, ((ptr) >> 2)) + SAFE_HEAP_LOAD(HEAPU32, (((ptr) + (4)) >> 2)) * 4294967296;
...
var writeI53ToI64 = (ptr, num) => {
  ...
  var offset = ((ptr) >> 2);
  if (deserialized != num) warnOnce(`writeI53ToI64() out of range: serialized JS Number ${num} to Wasm heap as bytes lo=${ptrToString(SAFE_HEAP_LOAD(HEAPU32, offset))}, hi=${ptrToString(SAFE_HEAP_LOAD(HEAPU32, offset + 1))}, which deserializes back to ${deserialized} instead!`);
};
...
/** @suppress {duplicate } */ var _glGetQueryivEXT = (target, pname, params) => {
  ...
  SAFE_HEAP_STORE(HEAP32, ((params) >> 2), GLctx.disjointTimerQueryExt["getQueryEXT"](target, pname));
};
...
/** @suppress {duplicate } */ var _glGetRenderbufferParameteriv = (target, pname, params) => {
  ...
  SAFE_HEAP_STORE(HEAP32, ((params) >> 2), GLctx.getRenderbufferParameter(target, pname));
};
...
/** @suppress {duplicate } */ var _glGetSamplerParameterfv = (sampler, pname, params) => {
  ...
  SAFE_HEAP_STORE(HEAPF32, ((params) >> 2), GLctx.getSamplerParameter(GL.samplers[sampler], pname));
};
...
/** @suppress {duplicate } */ var _glGetSamplerParameteriv = (sampler, pname, params) => {
  ...
  SAFE_HEAP_STORE(HEAP32, ((params) >> 2), GLctx.getSamplerParameter(GL.samplers[sampler], pname));
};
...
/** @suppress {duplicate } */ var _glGetUniformBlockIndex = (program, uniformBlockName) => {
...
/** @suppress {duplicate } */ var _glGetUniformIndices = (program, uniformCount, uniformNames, uniformIndices) => {
  ...
  program = GL.programs[program];
  var names = [];
  for (var i = 0; i < uniformCount; i++) names.push(UTF8ToString(SAFE_HEAP_LOAD(HEAP32, (((uniformNames) + (i * 4)) >> 2))));
...
/** @suppress {duplicate } */ var _glGetVertexAttribPointerv = (index, pname, pointer) => {
  ...
  SAFE_HEAP_STORE(HEAP32, ((pointer) >> 2), GLctx.getVertexAttribOffset(index, pname));
};
...
/** @suppress {duplicate } */ var _glTransformFeedbackVaryings = (program, count, varyings, bufferMode) => {
  ...
  program = GL.programs[program];
  var vars = [];
  for (var i = 0; i < count; i++) vars.push(UTF8ToString(SAFE_HEAP_LOAD(HEAP32, (((varyings) + (i * 4)) >> 2))));
...
/** @suppress {duplicate } */ var _glUniformMatrix2fv = (location, count, transpose, value) => {
  ...
  if (count <= 72) {
    ...
    for (var i = 0; i < count; i += 4) {
      ...
      view[i + 1] = SAFE_HEAP_LOAD(HEAPF32, (((value) + (4 * i + 4)) >> 2));
      view[i + 2] = SAFE_HEAP_LOAD(HEAPF32, (((value) + (4 * i + 8)) >> 2));
      view[i + 3] = SAFE_HEAP_LOAD(HEAPF32, (((value) + (4 * i + 12)) >> 2));
    }
  } else {
    var view = HEAPF32.subarray((((value) >> 2)), ((value + count * 16) >> 2));
  }
...
/** @suppress {duplicate } */ var _glUniformMatrix3fv = (location, count, transpose, value) => {
  ...
  if (count <= 32) {
    ...
    for (var i = 0; i < count; i += 9) {
      ...
      view[i + 2] = SAFE_HEAP_LOAD(HEAPF32, (((value) + (4 * i + 8)) >> 2));
      view[i + 3] = SAFE_HEAP_LOAD(HEAPF32, (((value) + (4 * i + 12)) >> 2));
      view[i + 4] = SAFE_HEAP_LOAD(HEAPF32, (((value) + (4 * i + 16)) >> 2));
      view[i + 5] = SAFE_HEAP_LOAD(HEAPF32, (((value) + (4 * i + 20)) >> 2));
      view[i + 6] = SAFE_HEAP_LOAD(HEAPF32, (((value) + (4 * i + 24)) >> 2));
      view[i + 7] = SAFE_HEAP_LOAD(HEAPF32, (((value) + (4 * i + 28)) >> 2));
      view[i + 8] = SAFE_HEAP_LOAD(HEAPF32, (((value) + (4 * i + 32)) >> 2));
    }
  } else {
...
/** @suppress {duplicate } */ var _glVertexAttrib2fv = (index, v) => {
  ...
  GLctx.vertexAttrib2f(index, SAFE_HEAP_LOAD(HEAPF32, v >> 2), SAFE_HEAP_LOAD(HEAPF32, v + 4 >> 2));
};
...
/** @suppress {duplicate } */ var _glVertexAttrib3fv = (index, v) => {
  ...
  GLctx.vertexAttrib3f(index, SAFE_HEAP_LOAD(HEAPF32, v >> 2), SAFE_HEAP_LOAD(HEAPF32, v + 4 >> 2), SAFE_HEAP_LOAD(HEAPF32, v + 8 >> 2));
};
...
/** @suppress {duplicate } */ var _glVertexAttrib4fv = (index, v) => {
  ...
  GLctx.vertexAttrib4f(index, SAFE_HEAP_LOAD(HEAPF32, v >> 2), SAFE_HEAP_LOAD(HEAPF32, v + 4 >> 2), SAFE_HEAP_LOAD(HEAPF32, v + 8 >> 2), SAFE_HEAP_LOAD(HEAPF32, v + 12 >> 2));
};
...
/** @suppress {duplicate } */ var _glVertexAttribI4iv = (index, v) => {
  ...
  GLctx.vertexAttribI4i(index, SAFE_HEAP_LOAD(HEAP32, v >> 2), SAFE_HEAP_LOAD(HEAP32, v + 4 >> 2), SAFE_HEAP_LOAD(HEAP32, v + 8 >> 2), SAFE_HEAP_LOAD(HEAP32, v + 12 >> 2));
};
...
/** @suppress {duplicate } */ var _glVertexAttribI4uiv = (index, v) => {
  ...
  GLctx.vertexAttribI4ui(index, SAFE_HEAP_LOAD(HEAPU32, v >> 2), SAFE_HEAP_LOAD(HEAPU32, v + 4 >> 2), SAFE_HEAP_LOAD(HEAPU32, v + 8 >> 2), SAFE_HEAP_LOAD(HEAPU32, v + 12 >> 2));
};
...
var _emscripten_request_fullscreen_strategy = (target, deferUntilInEventHandler, fullscreenStrategy) => {
  var strategy = {
    ...
    canvasResolutionScaleMode: SAFE_HEAP_LOAD(HEAP32, (((fullscreenStrategy) + (4)) >> 2)),
    filteringMode: SAFE_HEAP_LOAD(HEAP32, (((fullscreenStrategy) + (8)) >> 2)),
    deferUntilInEventHandler,
    canvasResizedCallback: SAFE_HEAP_LOAD(HEAP32, (((fullscreenStrategy) + (12)) >> 2)),
    canvasResizedCallbackUserData: SAFE_HEAP_LOAD(HEAP32, (((fullscreenStrategy) + (16)) >> 2))
  };
...
var ASM_CONSTS = {
  ...
  163390: () => (navigator.mediaDevices === undefined) ? 0 : 1,
  163449: ($0, $1, $2, $3, $4, $5, $6) => {
    const device = $0;
    const w = $1;
    const h = $2;
  ...
  167968: () => Module["SDL3"].audioContext.sampleRate,
  168019: ($0, $1, $2, $3) => {
    var SDL3 = Module["SDL3"];
      ...
      var makePointerEventCStruct = function(event) {
        ...
        if (event.pointerType == "pen") {
          ...
          if (ptr != 0) {
            ...
            var idx = ptr >> 2;
            SAFE_HEAP_STORE(HEAP32, idx++, event.pointerId);
            SAFE_HEAP_STORE(HEAP32, idx++, (typeof (event.button) !== "undefined") ? event.button : -1);
            SAFE_HEAP_STORE(HEAP32, idx++, event.buttons);
            SAFE_HEAP_STORE(HEAPF32, idx++, event.movementX);
            SAFE_HEAP_STORE(HEAPF32, idx++, event.movementY);
            SAFE_HEAP_STORE(HEAPF32, idx++, event.clientX - rect.left);
            SAFE_HEAP_STORE(HEAPF32, idx++, event.clientY - rect.top);
            SAFE_HEAP_STORE(HEAPF32, idx++, event.pressure);
            SAFE_HEAP_STORE(HEAPF32, idx++, event.tangentialPressure);
            SAFE_HEAP_STORE(HEAPF32, idx++, event.tiltX);
            SAFE_HEAP_STORE(HEAPF32, idx++, event.tiltY);
            SAFE_HEAP_STORE(HEAPF32, idx++, event.twist);
          }
        }
        return ptr;
      };
    ...
    if (target) {
      ...
      var makeDropEventCStruct = function(event) {
        ...
        if (ptr != 0) {
          var idx = ptr >> 2;
          var rect = target.getBoundingClientRect();
          SAFE_HEAP_STORE(HEAP32, idx++, event.clientX - rect.left);
          SAFE_HEAP_STORE(HEAP32, idx++, event.clientY - rect.top);
        }
        return ptr;
      };
  ...
  181743: () => window.innerWidth,
  181773: () => window.innerHeight,
  181804: $0 => {
